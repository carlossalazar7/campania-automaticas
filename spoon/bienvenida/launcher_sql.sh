...
echo $KETTLE_HOME
now="$(date +'%Y%m%d')"
logfilepath="/filemanager/BIN/CREDITS/CAMP_AUTOMATICAS/CMP_WELCOME/notif_automaticas_"${now}".log"
jobfilepath="/filemanager/BIN/CREDITS/CAMP_AUTOMATICAS/CMP_WELCOME/CAMP_AUTOMATICAS_BIENVENIDA_SQL_MAIN.kjb"
