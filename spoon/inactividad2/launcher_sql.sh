...
echo $KETTLE_HOME
now="$(date +'%Y%m%d')"
logfilepath="/filemanager/BIN/CREDITS/CAMP_AUTOMATICAS/CMP_INACT_2/notif_automaticas_"${now}".log"
jobfilepath="/filemanager/BIN/CREDITS/CAMP_AUTOMATICAS/CMP_INACT_2/CAMP_AUTOMATICAS_6_CORTES_SQL_MAIN.kjb"
