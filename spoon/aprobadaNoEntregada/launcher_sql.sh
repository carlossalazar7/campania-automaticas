...
echo $KETTLE_HOME
now="$(date +'%Y%m%d')"
logfilepath="/filemanager/BIN/CREDITS/CAMP_AUTOMATICAS/CMP_NOTIF_APPROV/notif_automaticas_"${now}".log"
jobfilepath="/filemanager/BIN/CREDITS/CAMP_AUTOMATICAS/CMP_NOTIF_APPROV/CAMP_AUTOMATICAS_AP_NE_SQL_MAIN.kjb"
